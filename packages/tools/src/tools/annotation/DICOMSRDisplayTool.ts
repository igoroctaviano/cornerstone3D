...
import { EventTypes, ToolHandle } from '../../types';
import { DICOMSRDisplayAnnotation } from '../../types/ToolSpecificAnnotationTypes';
...
export default class DICOMSRDisplayTool extends AnnotationTool {
  ...
  constructor(
    ...
    console.debug('DICOMSRDisplay cs3d');
    super(toolProps, defaultToolProps);
  }

  addNewAnnotation = (
    evt: EventTypes.InteractionEventType
  ): DICOMSRDisplayAnnotation => {
    console.log('addNewAnnotation', evt);
    return null;
  };
  ...
  handleSelectedCallback = (
    evt: EventTypes.InteractionEventType,
    annotation: DICOMSRDisplayAnnotation,
    handle: ToolHandle
  ): void => {
    console.log('handleSelectedCallback', evt, annotation, handle);
  };
  ...
  toolSelectedCallback = (
    ...
    console.log('toolSelectedCallback', evt, annotation);
  };
